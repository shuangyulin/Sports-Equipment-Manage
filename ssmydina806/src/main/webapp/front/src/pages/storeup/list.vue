<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"none","width":"1200px","fontSize":"16px","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 60px","margin":"0 auto 20px","color":"#5d62de","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250210/9a0a40c774bc481ca705fcfea9996859.png) no-repeat left center / 100% 100%","width":"101%","fontSize":"26px","lineHeight":"30px","position":"relative","fontWeight":"600","height":"40px"}'>我的收藏</div>
