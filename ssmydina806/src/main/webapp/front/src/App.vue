...
<style>
	* {
	...
	.breadcrumb-preview {
		...
		padding: 0px 20px;
		margin: 0px auto;
		background: linear-gradient(135.00deg, rgb(93, 98, 222) 0%,rgb(106, 17, 199) 100%);
		width: 100%;
	}
	...
	.breadcrumb-preview .el-breadcrumb .item1 .el-breadcrumb__inner a {
		padding: 0 20px;
		color: #666;
		background: url(http://codegen.caihongy.cn/20250211/82cac4fb7545456d98827f4ccb13b97f.png) no-repeat center top / 100% 100%;
